...
<body class="bg-light">
	<div align="center">
		<h2>Spring MVC Form Validation Example - Registration Form 1</h2>
		<h3>Validation with annotation</h3>
		<br><br>
		<table border="0" width="90%">
			<form:form method="post" modelAttribute="person" action="/register">
				<tr>
